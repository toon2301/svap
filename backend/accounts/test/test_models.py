...
class TestUserModel(TestCase):
    ...
    def test_user_str_individual(self):
        ...
        user = UserFactory(
            first_name="Ján", last_name="Novák", user_type=UserType.INDIVIDUAL
        )
        self.assertEqual(str(user), "Ján Novák")

    def test_user_str_company(self):
        """Test __str__ pre firmu"""
        user = UserFactory(company_name="Test Company", user_type=UserType.COMPANY)
...
class TestUserValidation(TestCase):
    ...
    def test_company_required_fields(self):
        ...
        user = UserFactory(user_type=UserType.COMPANY, company_name="Test Company")
