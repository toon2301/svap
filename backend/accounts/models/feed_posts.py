...
class FeedPost(models.Model):
    ...
    caption = models.TextField(_("Text"), max_length=500, blank=True, default="")
    ...
    def save(self, *args, **kwargs):
        """Pri vzniku zdieľania over viditeľnosť cieľa a denormalizuj snapshot.
        ...
        """
        if self.pk is None:
            if self.shared_offer_id is not None:
            ...
            if self.shared_portfolio_item_id is not None:
