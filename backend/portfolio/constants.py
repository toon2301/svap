PORTFOLIO_CATEGORY_CHOICES = frozenset(
    {
        "it-a-technologie",
        "remesla-a-vyroba",
        "domacnost-a-sluzby",
...
def normalize_portfolio_category(value: str) -> str:
    category = str(value).strip()
    return PORTFOLIO_CATEGORY_ALIASES.get(category.casefold(), category)
