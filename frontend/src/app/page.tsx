  ...
  return (
    <div className="min-h-screen flex flex-col relative" style={{background: 'linear-gradient(135deg, #F3F0FF 0%, #E9E5FF 100%)'}}>
      ...
      >
        ...
        >
          <span className="text-6xl max-lg:text-4xl">Víta ťa</span> <span className="font-bold" style={{color: '#6B46C1'}}>Svaply</span><span className="text-6xl max-lg:text-4xl">!</span>
        </motion.h1>
        <motion.p 
