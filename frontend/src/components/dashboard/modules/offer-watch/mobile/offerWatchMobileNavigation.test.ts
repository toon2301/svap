...
describe('offerWatchMobileNavigation', () => {
  ...
  it.each([
    null,
    { __svaplyOfferWatchMobile: { version: 2, origin: 'settings', view: { kind: 'list' } } },
    { __svaplyOfferWatchMobile: { version: 1, origin: 'unknown', view: { kind: 'list' } } },
    { __svaplyOfferWatchMobile: { version: 1, origin: 'settings', view: { kind: 'edit', watchId: 0 } } },
    { __svaplyOfferWatchMobile: { version: 1, origin: 'settings', view: { kind: 'edit', watchId: 1.5 } } },
