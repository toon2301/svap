            ...
            <div className="flex flex-col gap-[clamp(1rem,2.5vw,1.5rem)] w-full">
              ...
              >
                <div className="text-center">
                  ...
                  <div className="mx-auto mt-2 h-0.5 w-20 bg-gray-300 dark:bg-gray-700 rounded-full" />
                  <div className="mt-3 text-[clamp(0.75rem,1.2vw,0.875rem)] text-gray-700 dark:text-gray-300">{t('skills.searchCta', 'Hľadáš zručnosť? Hľadaj ju na Svaply kliknutím sem.')}</div>
                </div>
              </button>
            </div>
          </div>
          ...
          <div className="w-full py-6">
            <div className="flex flex-col gap-4 w-full">
              <button 
                type="button" 
                onClick={onOffer} 
                className="w-full h-24 flex items-center justify-center rounded-2xl border-2 border-[var(--border)] bg-[var(--background)] active:bg-gray-50 dark:active:bg-gray-900 transition-colors"
              >
                <div className="text-center">
                  <div className="text-xl font-extrabold text-gray-900 dark:text-white">{t('skills.offer', 'Ponúkam')}</div>
                  <div className="mx-auto mt-1.5 h-0.5 w-16 bg-gray-300 dark:bg-gray-700 rounded-full" />
                  <div className="mt-2 text-xs text-gray-700 dark:text-gray-300 px-4">{t('skills.offerCta', 'Ponúkaš zručnosť? Pridaj ju na Svaply kliknutím sem.')}</div>
                </div>
              </button>
              <button 
                type="button" 
              ...
              >
                <div className="text-center">
                  <div className="text-xl font-extrabold text-gray-900 dark:text-white">{t('skills.search', 'Hľadám')}</div>
                  <div className="mx-auto mt-1.5 h-0.5 w-16 bg-gray-300 dark:bg-gray-700 rounded-full" />
                  <div className="mt-2 text-xs text-gray-700 dark:text-gray-300 px-4">{t('skills.searchCta', 'Hľadáš zručnosť? Hľadaj ju na Svaply kliknutím sem.')}</div>
                </div>
              </button>
            </div>
          </div>
