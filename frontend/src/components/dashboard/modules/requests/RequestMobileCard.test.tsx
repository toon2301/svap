...
describe('RequestMobileCard – zmazaný používateľ', () => {
  const deletedItem = {
    ...
    status: 'accepted',
    recipient: 88,
    recipient_display_name: 'deleted-user-0123456789abcdef0123456789abcdef',
    recipient_summary: {
      id: 88,
      display_name: 'deleted-user-0123456789abcdef0123456789abcdef',
      slug: 'deleted-user-0123456789abcdef0123456789abcdef',
      avatar_url: null,
    },
    requester: 1,
    requester_display_name: 'Me',
