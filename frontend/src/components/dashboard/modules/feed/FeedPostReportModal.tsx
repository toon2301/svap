        ...
        <div className="flex-1 overflow-y-auto p-4 sm:p-6">
          ...
          <div className="mt-4">
            ...
            <textarea
              ...
              className="w-full resize-y rounded-lg border border-gray-300 px-3 py-2.5 text-gray-900 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400/60 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-900/50 dark:text-white dark:placeholder-gray-500"
            />
          </div>
